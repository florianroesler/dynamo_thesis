...
\begin{description}[style=nextline]
	...
	Jobs carry a weight with them that determines their priority and number of tasks. Example: Job A (weight 1) with two tasks a and Job B (weight 2) with tasks b will lead to the order bbabba.
\end{description}
