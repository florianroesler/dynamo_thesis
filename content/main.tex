...
It must be noted that schedulers on this tier may rightfully ignore the order of tasks given by the first tier. For example the first tier might hand over a list of tasks in FIFO order. If this list is handled by a Simplex based scheduler on the second tier, the principle of FIFO may be violated in favor of finding the optimal distribution.
