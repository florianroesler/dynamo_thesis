\begin{titlepage}
	...
	\vfill
	{\textbf{Supervision}\\\usekomafont{publishers}\hpisupervisor\\\textit{\hpichair}\\\smallskip\textbf{\normalfont\hpiexternalsupervisor}\\\textit{\hpiexternal}}

	\vspace*{2\baselineskip}
	{\usekomafont{date}Hasso-Plattner Institute at the University of Potsdam}\par
	\vspace*{\baselineskip}
